  ...
  <body>
    ...
    <section id="profile">
      ...
      <div class="section__text">
        ...
        <h1 class="title"> Yathartha Shrestha</h1>
        ...
        <div class="about-details-container">
          <div class="about-containers">
            <div class="details-container">
              ...
              <h3>Experience</h3>
              <p>2+ years <br />Video Editor <br> 1+ years <br> Graphic Designer</p>
            </div>
            <div class="details-container">
              <img src="${pageContext.request.contextPath}/assets/All Images/education.png" alt="Education icon" class="icon"
              />
              <h3>Education</h3>
              <p>C.S: Plus 2<br /> Graphic Design: Diploma <br>B.Sc.(Computing): Running</p>
            </div>
          </div>
    ...
    <section id="experience">
      ...
      <div class="experience-details-container">
        <div class="about-containers">
          <div class="details-container">
            <h2 class="experience-sub-title">Video Editor</h2>
          ...
          <div class="details-container">
            <h2 class="experience-sub-title">Graphic Designer</h2>
            <div class="article-container">
              <article>
                <img  src="${pageContext.request.contextPath}/assets/All Images/checkmark.png"  alt="Experience icon" class="icon" />
                <div>
      ...
      <section id="contact">
        ...
        <div class="contact-info-container">
          ...
          <p><a href="mailto:examplemail@gmail.com">Yatharthastha234@gmail.com</a></p>
        </div>
      </section>
