  ...
  <body>
    ...
    <section id="profile">
      <div class="section__pic-container">
        <img src="${pageContext.request.contextPath}/assets/All Images/niran11.jpg "  />
      </div>
      <div class="section__text">
        <p class="section__text__p1">Nice to meet you! <br> I am</p>
        <h1 class="title"> Niran Bhatta</h1>
        <p class="section__text__p2">Marketing Manager and Database</p>
        ...
        <div class="about-details-container">
          <div class="about-containers">
            <div class="details-container">
              ...
              <h3>Experience</h3>
              <p>2+ years <br />Marketing Manager<br> 1+ years <br> Database</p>
            </div>
            <div class="details-container">
              <img src="${pageContext.request.contextPath}/assets/All Images/education.png" alt="Education icon" class="icon"
              />
              <h3>Education</h3>
              <p>C.S +2<br /> Diploma Database <br>B.Sc.(Computing): Running</p>
            </div>
          </div>
    ...
    <section id="experience">
      ...
      <div class="experience-details-container">
        <div class="about-containers">
          <div class="details-container">
            <h2 class="experience-sub-title">Marketing Manager</h2>
      ...
      <section id="contact">
        ...
        <div class="contact-info-container">
          ...
          <p><a href="mailto:examplemail@gmail.com">nirankafle20@gmail.com</a></p>
        </div>
      </section>
