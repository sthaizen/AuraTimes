  ...
  <body>
    ...
    <section id="profile">
      ...
      <div class="section__text">
        ...
        <h1 class="title"> Sujal Parajuli</h1>
        <p class="section__text__p2">Backend Developer and Machine Learning</p>
        ...
        <div class="about-details-container">
          <div class="about-containers">
            <div class="details-container">
              ...
              <h3>Experience</h3>
              <p>2+ years <br />Backend Developer<br> 1+ years <br> Machine Learning</p>
            </div>
            <div class="details-container">
              <img src="${pageContext.request.contextPath}/assets/All Images/education.png" alt="Education icon" class="icon"
              />
              <h3>Education</h3>
              <p>C.S: Plus 2<br /> Backend: Diploma <br>B.Sc.(Computing): Running</p>
            </div>
          </div>
    ...
    <section id="experience">
      ...
      <div class="experience-details-container">
        <div class="about-containers">
          ...
          <div class="details-container">
            <h2 class="experience-sub-title">Machine Learning</h2>
            <div class="article-container">
              <article>
                <img  src="${pageContext.request.contextPath}/assets/All Images/checkmark.png"  alt="Experience icon" class="icon" />
                <div>
      ...
      <section id="contact">
        ...
        <div class="contact-info-container">
          ...
          <p><a href="mailto:examplemail@gmail.com">sujalparajuli@gmail.com</a></p>
        </div>
      </section>
