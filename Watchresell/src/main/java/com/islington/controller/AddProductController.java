...
@WebServlet(asyncSupported = true, urlPatterns = { "/addProductController" })
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try (Connection con = DbConfig.getDbConnection()) {
                String sql = "INSERT INTO products (product_name, description, product_price, product_img, watch_brand, previous_bid) VALUES (?, ?, ?, ?, ?, ?)";
